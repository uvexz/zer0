...
export const profiles = pgTable(
  "profiles",
  {
    ...
    defaultZostVisibility: visibilityEnum("default_zost_visibility").notNull().default("public"),
    isDiscoverable: boolean("is_discoverable").notNull().default(true),
    manuallyApprovesFollowers: boolean("manually_approves_followers").notNull().default(false),
